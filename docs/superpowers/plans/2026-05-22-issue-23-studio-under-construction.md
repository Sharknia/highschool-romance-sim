...
- [ ] **Step 1: Rewrite old legacy IA assertions**
...
- [ ] **Step 2: Run shell/use-case tests to verify RED**
...
- [ ] **Step 3: Remove event/assets from visible branches**
...
- [ ] **Step 4: Run shell/use-case tests to verify GREEN**
...
- [ ] **Step 1: Write source assertions for shared density classes**
...
- [ ] **Step 2: Run shell test to verify RED/GREEN**
...
- [ ] **Step 4: Browser density check before the #23 commit**
...
- [ ] **Step 1: Comment before implementation**
